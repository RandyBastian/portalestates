					...
					<div class="row">
						...
						<div class="col-lg-4">
							...
							<ul class="footer-posts">
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/1.jpg" class="img-circle" alt="" ></div>
									<div class="info">
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/2.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/3.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
						...
						<div class="col-lg-4">
							...
							<ul class="footer-posts">
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/4.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/5.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/6.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
						...
						<div class="col-lg-4">
							...
							<ul class="footer-posts">
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/7.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/8.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
								...
								<li>
									<div class="pic"><img src="<?php echo base_url(); ?>assets/frontend/images/images/footer/recent-posts/9.jpg" class="img-circle" alt="" ></div>
									<div class="info">
										<span class="date"><i class="fa fa-calendar-o"></i> 01/01/2015</span>                        
										<span class="comments pull-right"><i class="fa fa-comment-o"></i> 750</span>
										<span class="likes pull-right"><i class="fa fa-heart-o"></i> 500</span>
