					...
					<div class="col-lg-12">
						...
						<section>
							<div class="row category-caption">
								<div class="col-lg-12">
									<h2 class="pull-left sub-cat"><a style="color:white" href="<?php echo site_url("privacy-policy"); ?>">PRIVACY POLICY</a></h2>
								</div>
							</div>
							<div class="row">
